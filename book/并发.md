...
[`Send`](https://doc.rust-lang.org/std/marker/trait.Send.html). When a type `T` implements `Send`, it
...
The second of these traits is called [`Sync`](https://doc.rust-lang.org/std/marker/trait.Sync.html).
...
Note that [`lock`](https://doc.rust-lang.org/std/sync/struct.Mutex.html#method.lock) method of
[`Mutex`](https://doc.rust-lang.org/std/sync/struct.Mutex.html) has this signature:
