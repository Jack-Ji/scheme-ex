...
如果还是看不到以上信息，你可以在下面几个地方寻求帮助。最容易的方式是通过[Mozilla
提供的IRC初学者聊天频道][irc-beginners]，更高级的话题也可求助于[常用聊天频道]
[irc]。你可通过[Mibbit网站][mibbit]提供的服务直接进入这些频道。在这些频道中你可
以自由的和其他Rustaceans（rust开发者的昵称）交流相关话题。其它可获取帮助的渠道
还有[Rust用户论坛][users]和[Stack Overflow网站][stackoverflow]。
