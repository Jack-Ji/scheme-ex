...
[Mozilla 提供的IRC初学者聊天频道][irc-beginners]，更高级的话题也可求助于
[常用聊天频道][irc]。你可通过[Mibbit网站][mibbit]提供的服务直接进入这些频道。
在这些频道中你可以自由的和其他Rustaceans（rust开发者的昵称）交流相关话题。
其它可获取帮助的渠道还有[Rust用户论坛][users]和[Stack Overflow网站][stackoverflow]。
