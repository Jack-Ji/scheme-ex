...
could [`panic`](https://doc.rust-lang.org/std/macro.panic.html) whenever we
...
`FromStr`](https://doc.rust-lang.org/std/primitive.i32.html) (do a `CTRL-F` in your browser
...
[`unwrap_or`](https://doc.rust-lang.org/std/result/enum.Result.html#method.unwrap_or) and
...
[`map_err`](https://doc.rust-lang.org/std/result/enum.Result.html#method.map_err) (instead of
`map`) and [`or_else`](https://doc.rust-lang.org/std/result/enum.Result.html#method.or_else)
(instead of `and_then`).
...
with [`io::Result`](https://doc.rust-lang.org/std/io/type.Result.html). Typically, one writes
...
[`std::io::Error`](https://doc.rust-lang.org/std/io/struct.Error.html) type. We know this
because of the return types of
[`std::fs::File::open`](https://doc.rust-lang.org/std/fs/struct.File.html#method.open) and
...
alias](https://doc.rust-lang.org/std/io/type.Result.html), and consequently, the underlying
...
(The [real definition](https://doc.rust-lang.org/std/macro.try.html) is a bit more
...
[`std::convert::From`](https://doc.rust-lang.org/std/convert/trait.From.html). While `Error`
...
library](https://doc.rust-lang.org/std/error/trait.Error.html):
...
library](https://doc.rust-lang.org/std/convert/trait.From.html):
...
[in the standard library](https://doc.rust-lang.org/std/macro.try.html):
...
[`description`](https://doc.rust-lang.org/std/error/trait.Error.html#tymethod.description)
and [`cause`](https://doc.rust-lang.org/std/error/trait.Error.html#method.cause), but the
...
[`ErrorKind`](https://doc.rust-lang.org/std/io/enum.ErrorKind.html)) or keep it hidden (like
[`ParseIntError`](https://doc.rust-lang.org/std/num/struct.ParseIntError.html)). Regardless
...
for [`io::Result`](https://doc.rust-lang.org/std/io/type.Result.html)
and [`fmt::Result`](https://doc.rust-lang.org/std/fmt/type.Result.html).
...
1. [`File::open`](https://doc.rust-lang.org/std/fs/struct.File.html#method.open)
   can return an
...
by using the [corresponding `From` impls](https://doc.rust-lang.org/std/convert/trait.From.html):
...
* Otherwise, in a program, define your own error types with appropriate
  ...
  and
  [`Error`](https://doc.rust-lang.org/std/error/trait.Error.html)
  impls to make the [`try!`](https://doc.rust-lang.org/std/macro.try.html)
...
* If you're writing a library and your code can produce errors, define your own
  ...
  [`From`](https://doc.rust-lang.org/std/convert/trait.From.html) to make both
...
[2]: https://doc.rust-lang.org/std/option/enum.Option.html#method.map
[3]: https://doc.rust-lang.org/std/option/enum.Option.html#method.unwrap_or
[4]: https://doc.rust-lang.org/std/option/enum.Option.html#method.unwrap_or_else
[5]: https://doc.rust-lang.org/std/option/enum.Option.html
[6]: https://doc.rust-lang.org/std/result/index.html
[7]: https://doc.rust-lang.org/std/result/enum.Result.html#method.unwrap
[8]: https://doc.rust-lang.org/std/fmt/trait.Debug.html
[9]: https://doc.rust-lang.org/std/primitive.str.html#method.parse
